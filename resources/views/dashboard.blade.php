            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-green-500">
                        ...
                        <div class='mt-5'>
                            <div class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                                <div class="flex w-full items-center justify-between border-b pb-3">
                                    ...
                                    <div class="flex items-center space-x-8">
                                        <button
                                            class="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs text-neutral-500 font-semibold">4543</button>
                                        <div class="text-xs text-neutral-500">2 hours ago</div>
                                    </div>
                                </div>

                                <div class="mt-4 mb-6">
                                    <div class="mb-3 text-blue-500 font-bold">Nulla sed leo tempus, feugiat velit vel,
                                        rhoncus
                                        neque?</div>
                            ...
                            <div class="rounded-xl  border p-5 mt-5 shadow-md w-9/12 bg-white">
                                <div class="flex w-full items-center justify-between border-b pb-3">
                                    ...
                                    <div class="flex items-center space-x-8">
                                        <button
                                            class="rounded-2xl border bg-100 px-3 py-1 text-xs text-neutral-500  font-semibold">4543</button>
                                        <div class="text-xs text-neutral-500">2 hours ago</div>
                                    </div>
                                </div>
                    ...
                    @else
                        {{-- {{ __("Your client") }} --}}
                        <div
                            class='flex items-center  from-teal-100 via-teal-300 to-teal-500 bg-white-to-br'>
                            <div class='w-full max-w-lg px-10 py-8 mx-auto  rounded-lg shadow-xl'>
                                <div class='max-w-md mx-auto space-y-6'>
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <textarea 
                                         rows="5" class=" p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none"></textarea>
